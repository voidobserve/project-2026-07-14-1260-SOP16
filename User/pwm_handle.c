...
{
	pwm_handle_param.dest_mode = PWM_MODE_ON;
...
// TODO 待优化，修改参数后立即调用该函数，应该 改为 pwm_handle_reflash_expect_pwm_duty_val 
/**
 * @brief PWM处理函数
 * @details 根据颜色索引和亮度级别设置PWM占空比
 */
...
void pwm_handle_in_mode_on(void)
{
	// =================================================================
	// pwm_channel_0                                               //
	// =================================================================
